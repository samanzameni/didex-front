  ...
  if (
    ...
    var e,
      ...
      d = {
        ...
        calculateWidgetHeight: function (e, t) {
          ...
          return n && t && (this.embedStylesForFullHeight(i + o, r, t), r)
            ? 100 + o
            : r
            ? 'calc(' + i + o + ' - 32px)'
            : i + o;
        ...
        css: function (e) {
          ...
          (o.type = 'text/css'),
            o.styleSheet
              ...
              : ((t = document.createTextNode(e)), o.appendChild(t)),
            i.appendChild(o);
        },
        ...
        widget: function (e) {
          ...
          (this.options = {
            ...
            ref_landing_page: e.ref_landing_page,
        ...
        QuotesProvider: function (e) {
          ...
          function r(e) {
            ...
            o &&
              n &&
              r &&
              (i.post(t.contentWindow, 'resolveSymbol', { symbol: o }),
              n &&
                i.on('success' + o, function (e) {
                  n(e);
                }),
              r &&
                i.on('error' + o, function (e) {
                  r(e);
                }));
          }
          l(
            '<iframe id="' +
              ...
              '" src="' +
              n +
              '" width="0" height="0" frameborder="0" allowTransparency="true" scrolling="no"></iframe>',
            e.container
          ),
            (t = document.getElementById(o)),
            (i = d.postMessageWrapper(t.contentWindow, o)),
            d.bindEvent(t, 'load', function () {
              e.symbols.forEach(r);
            });
        },
      };
    (d.DependenciesManager = function () {}),
      (d.DependenciesManager.prototype.scripts = {}),
      (d.DependenciesManager.prototype._loaded = function (e) {
      ...
      (d.DependenciesManager.prototype.depends = function (e, t, i) {
        for (var o = 0; o < e.length; o++)
          this.scripts[e[o]] && !0 === this.scripts[e[o]].status
            ? i()
            : this.scripts[e[o]] && !1 === this.scripts[e[o]].status
            ? (this.scripts[e[o]].callbacks[t] = i)
            : ((this.scripts[e[o]] = {
                status: !1,
              ...
              (this.scripts[e[o]].callbacks[t] = i),
              (this.scripts[e[o]].script.onload = this._loaded.bind(
                this,
                e[o]
              )),
              (this.scripts[e[o]].script.src = d.host + e[o]),
              document.body.appendChild(this.scripts[e[o]].script));
      }),
      (d.dependenciesManager = new d.DependenciesManager()),
      (d.WidgetAbstract.prototype = {
        ...
        width: function () {
          return this.options.autosize
            ? '100%'
            : d.WidgetAbstract.prototype.fixSize(this.options.width);
        },
        height: function () {
          return this.options.autosize
            ? '100%'
            : d.WidgetAbstract.prototype.fixSize(this.options.height);
        },
      ...
      (d.UserInfoWidget.prototype = {
        ...
        widgetCode: function () {
          ...
          var t =
            '&' +
            d.generateUtmForUrlParams(this.options, { type: 'UserInfoWidget' });
          return (
            '<iframe src="' +
      ...
      (d.ChatWidgetEmbed.prototype = {
        ...
        widgetCode: function () {
          ...
          return (
            '<iframe src="' +
            (d.chatHost + '/chatwidgetembed/?' + i + t + e) +
            '"' +
            (this.options.width ? ' width="' + this.options.width + '"' : '') +
            (this.options.height
              ? ' height="' + this.options.height + '"'
      ...
      (d.IdeaWidget.prototype = {
        createWidget: function () {
          ...
          (this.postMessage = d.postMessageWrapper(i.contentWindow, this.id)),
            this.postMessage.on(
              'resize',
              function (e) {
        ...
        widgetCode: function () {
          ...
          if (this.options.tabs) {
            ...
            for (var w = this.options.tabs.length; g < w; g++) {
              ...
              this.options.symbols[f] &&
                (e +=
                  (e ? '&' : '') +
                  encodeURIComponent(f) +
                  '=' +
                  y(this.options.symbols[f]));
            }
          ...
          if (this.options.symbols_description)
            for (var b in this.options.symbols_description)
              i +=
                '&' +
                encodeURIComponent(b) +
                '=' +
                encodeURIComponent(this.options.symbols_description[b]);
          this.options.customer && (o = '/' + this.options.customer + o);
          var v = d.host + o + '?' + e + t + i + p + n + r + s + a + l + h;
          return (
            '<iframe id="' +
            this.id +
            '" src="' +
      ...
      (d.MediumWidget.prototype = {
        ...
        widgetCode: function () {
          ...
          var y = d.host + u + '?' + t + e + a + p + g + i + o + n + m + r;
          return (
            '<iframe id="' +
            this.id +
            '" src="' +
          ...
          i && i.parentElement && i.parentElement.removeChild(i),
            ...
            t.postMessage.on('logoCreated', function (e) {
              if (e.left && e.bottom && e.width && e.height && e.href) {
                ...
                e.text &&
                  ((i.textContent = e.text), (i.style.color = 'transparent')),
                  ...
                  (t._logoOverlay = i),
                  document.getElementById(t.id + '-wrapper').appendChild(i);
              }
            }),
            ...
            t.postMessage.on('openChartInPopup', function (e) {
              for (
                var i = d.cloneSimpleObject(t.options),
                  o = ['symbol', 'interval'],
                  n = o.length - 1;
                n >= 0;
                n--
          ...
          return (
            (t =
              'cme' === (e = e || this.options).customer
                ...
                : '/widgetembed/'),
            (e.enable_publishing ? d.ideasHost : d.host) +
              t +
              '?frameElementId=' +
              this.id +
              '&symbol=' +
              ...
              i('hide_side_toolbar', 'hidesidetoolbar') +
              i('allow_symbol_change', 'symboledit') +
              i('save_image', 'saveimage') +
              '&toolbarbg=' +
              e.toolbar_bg.replace('#', '') +
              (e.watchlist && e.watchlist.length && e.watchlist.join
                ? '&watchlist=' + encodeURIComponent(e.watchlist.join(''))
                : '') +
              o('editablewatchlist', '1') +
              o('details', '1') +
              o('calendar', '1') +
              o('hotlist', '1') +
              (e.studies && d.isArray(e.studies)
                ? 'string' == typeof e.studies[0]
                  ? o('studies', encodeURIComponent(e.studies.join('')))
                  : n('studies', e.studies)
                : '') +
              i('horztouchdrag') +
              i('verttouchdrag') +
              o('widgetbar_width', e.widgetbar_width, 'widgetbarwidth') +
              o('hideideas', '1') +
              o('theme', encodeURIComponent(e.theme)) +
              o('style', encodeURIComponent(e.style)) +
              (void 0 === e.extended_hours
                ? ''
                : '&extended_hours=' + e.extended_hours) +
              o('timezone', encodeURIComponent(e.timezone)) +
              o('hideideasbutton', '1') +
              o('withdateranges', '1') +
              o('hidevolume', '1') +
              (void 0 === e.padding ? '' : '&padding=' + e.padding) +
              o('show_popup_button', '1', 'showpopupbutton') +
              ...
              if (
                ...
                for (
                  var o = document.getElementsByTagName('a'),
                    n = new RegExp('/v/' + i.options.chart + '/$'),
                    r = new RegExp(
                      '/chart/([0-9a-zA-Z:+*-/()]+)/' + i.options.chart
                    ),
                    s = 0;
                  s < o.length;
                  s++
          ...
          function () {
            ...
            i.appendChild(o),
              new window.Spinner()
                ...
                .spin(o),
              (i.style.cssText =
                'position: fixed;left: 0;top: 0;width: 100%;height: 100%;background: rgba(0, 0, 0, 0.5);z-index: 120;-webkit-transform: translate3d(0, 0, 0);'),
            ...
            (h.innerHTML = l),
              (h.style.cssText =
                'position: absolute;left: 50%;top: 50%;margin-top: -325px;margin-left: -235px;'),
              i.appendChild(h);
      ...
      (d.isSignedIn = function (e, t) {
        ...
        var a = document.getElementById(i),
          ...
          h = function (e) {
            e.id === i &&
              (document.body.removeChild(s), t(e.user), l.off('close', h));
          };
        l.on('close', h, !0);
      }),
      (d.onLoginStateChange = function (e, t) {
        ...
        (s.innerHTML = r), document.body.appendChild(s);
        var a = document.getElementById(i);
        d.postMessageWrapper(a.contentWindow, i).on(
          'loginStateChange',
          function (e) {
            e.id === i && t(e.user);
          },
          ...
          window.addEventListener('message', function (e) {
            ...
            if (n && n.provider && 'TradingView' === n.provider)
              if (((n.source = e.source), 'get' === n.type)) {
                ...
                i[n.client_id] &&
                  i[n.client_id][n.id] &&
                  (i[n.client_id][n.id].call(n, n.data),
                  delete i[n.client_id][n.id]);
              else if ('post' === n.type) {
                if (!o[n.name]) return;
                o[n.name].forEach(function (e) {
    ...
    var l = function (e, t) {
        ...
        if (i) {
          ...
          var o =
            i.parentElement &&
            i.parentElement.querySelector('.tradingview-widget-copyright');
